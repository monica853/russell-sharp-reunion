...
const inputClass =
  "w-full bg-transparent border border-[var(--gold)]/40 focus:border-[var(--gold)] focus:outline-none px-3 py-2 text-[var(--pearl)]";
        ...
        {!loading && invoice && (
          <div className="card-plaque p-6 sm:p-8 space-y-6">
            <div>
              ...
              {invoice.familyBranch && (
                <p className="text-sm text-[var(--pearl-dim)]">{invoice.familyBranch} branch</p>
              )}
            </div>
